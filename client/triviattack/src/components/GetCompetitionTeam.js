...
class GetCompetitionTeam extends Component {
    ...
    getCompetitionTeam(){
          let endpoint = "/getCompetitionTeam"
    ...
    render() {
        return (
            <div className='get-competition-team'>
                <div>
                    <span className="section-header"> Get User Info: </span>
                </div>
                <div>
                   <span>Potential Comp Teams: {this.props.outputText}</span> 
                </div>
                <div >
                    <div>
                        <span>User ID</span>
                ...
                <button onClick={() => this.getCompetitionTeam()}>
                    Submit
                </button>
            </div>
        );
...
export default GetCompetitionTeam